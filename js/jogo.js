    ...
    function acertou(carta) {
      ...
      img.src = "https://em-content.zobj.net/source/apple/81/bouquet_1f490.png";
    ...
    function errou(carta) {
      ...
      img1.id = "imagem";
      //altera o atributo src (source) da imagem criada
      img1.src = "https://thumbs.dreamstime.com/z/o-que-%C3%A9-emoticon-errado-confundido-do-emoji-guarda-para-fora-sua-m%C3%A3o-com-palma-girou-cima-e-fazendo-um-gesto-fosse-ou-fizesse-153822857.jpg?w=768";
      //adiciona a imagem criada na div (carta) escolhida pelo jogador (appendChild)
